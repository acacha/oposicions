...
void buscarsortida (int pos, int filinici, int colinici, int filfinal,int colfinal,QUADRE *laberint,int nfiles,int ncolumnes);
...
int main(int argc, char **argv) {
	...
	buscarsortida(filinici*ncolumnes + colinici,filinici,colinici, filfinal,colfinal, laberint, nfiles, ncolumnes);
...
void buscarsortida (int pos, int filinici, int colinici, int filfinal,int colfinal,QUADRE *laberint,int nfiles,int ncolumnes) {
	...
	int posFinal,posInicial,i,fila,columna;
	posFinal=filfinal*ncolumnes + colfinal;
	posInicial=filinici*ncolumnes + colinici;
		...
		switch (i) {
			case 0: //DRETA
				if (esMovimentValid(fila,columna,i,nfiles,ncolumnes,laberint)){
					...
					buscarsortida (pos+1,filinici,colinici,filfinal,colfinal,laberint,nfiles,ncolumnes);
			...
			case 1: //ABAIX
				if (esMovimentValid(fila,columna,i,nfiles,ncolumnes,laberint)){
					...
					buscarsortida (pos+ncolumnes,filinici,colinici,filfinal,colfinal,laberint,nfiles,ncolumnes);
